<script>
	...
	let jobs = [
		{ waitTime: null, timeLimit: null, city: 'Berkeley', type: 'Uber' },
		{ waitTime: null, timeLimit: null, city: 'Berkeley', type: 'UberEats' },
		{ waitTime: null, timeLimit: null, city: 'SF', type: 'Uber' },
		{ waitTime: null, timeLimit: null, city: 'SF', type: 'UberEats' }
	];
...
<div class="choices">
	<Card jobData={jobs[0]} color="#ecb98d" />
	<Card jobData={jobs[1]} color="#eea7cf" />
	<Card jobData={jobs[2]} color="#96f0c8" />
	<Card jobData={jobs[3]} color="#89bbed" />
</div>
